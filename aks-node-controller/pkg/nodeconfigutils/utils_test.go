...
func TestCustomDataUsesMultipartBoothookAndCloudConfig(t *testing.T) {
	...
	require.Contains(t, string(boothook), "launching aks-node-controller wrapper directly")
	require.Contains(t, string(boothook), "/opt/azure/containers/aks-node-controller-wrapper.sh >/dev/null 2>&1 &")
